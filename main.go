...
func initRoutes() *mux.Router {
	...
	router.HandleFunc("/api/leagues/{league:[0-9]+}/admins/{admin:[0-9]+}",
		leagueAdminHandler)

	router.HandleFunc("/api/leagues/{league:[0-9]+}/leaders",
	...
	router.HandleFunc("/api/leagues/{league:[0-9]+}/teams/{team:[0-9]+}/leaders",
